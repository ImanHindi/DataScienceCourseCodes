...
#python CatAndDogsClassifier.py --dataset C:\Users\user\Desktop\iman\MLlibraries\dogs-vs-cats\train --model output/BasicCatAndDogsClassifier.hdf 

#testing model command line :
#    python CatAndDogsClassifiertester.py --model output/BasicCatAndDogsClassifier.hdf --test-images C:\Users\user\Desktop\iman\MLlibraries\dogs-vs-cats\test
